...
<div id="wrapper">
            ...
            <ul class="nav" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li>
                            <a class="J_menuItem" href="${contextPath}/jsp/blog/classify/index.jsp">分类管理</a>
                        </li>
                        <li>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row J_mainContent" id="content-main">
            <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="${contextPath}/index1.jsp" frameborder="0" data-id="${contextPath}/index1.jsp" seamless></iframe>
        </div>
        <div class="footer">
